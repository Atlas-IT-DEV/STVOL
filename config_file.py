...
def save_default_config():
    ...
    config_data = {
        ...
        "DISCOUNT_INVITE": 15,  # Скидка на покупку, если покупатель зарегистрировал друга по реферальному коду. [%]
        "DISCOUNT_BONUS_LIMIT_FOR_PURCHASE": 50,  # Ограничение на скидку стоимости заказа при использовании бонусов. [%]
        "PERCENTAGE_BONUS_FOR_ORDER": 2  # Процент бонусов начисляемый от стоимости заказа. [%]
    }
